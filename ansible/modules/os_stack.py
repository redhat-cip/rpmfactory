...
options:
   ...
   parameters:
     description:
        - Parameter values separated by a semicolon used to create the stack
   environment_files:
     description:
        - Environment files list separated by a semicolon
   wait_for_complete:
     description:
...
def main():
    argument_spec = openstack_full_argument_spec(
        ...
        environment_files   = dict(default=''),
    ...
    parameters = module.params['parameters'].strip()
    environment_files = module.params['environment_files'].strip()
    ...
    try:
        ...
        if state == 'present':
            ...
            # Create stack
            env_files = environment_files.split(',')
